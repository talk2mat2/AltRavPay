...
const OverView = () => {
	return (
		<Container maxW="515px" py={8}>
			<Heading as="h1" fontSize="20px" color="#000000" fontWeight="700" mb={4}>
				Hello Mayowa
			</Heading>
			...
			<Alert
				...
				<AlertTitle fontSize={"10px"} w="419px">
					Process customer's payment by clicking on{" "}
					<b style={{ color: "#000000" }}>"Generate WebGUID"</b>.<br /> Process
					payment by clicking on{" "}
					<b style={{ color: "#000000" }}>"Data Capture"</b>
				</AlertTitle>
			</Alert>

			{/* Fixed 515px container for the 4 cards */}
			<Box mx="auto">
				<Grid templateColumns="repeat(2, 1fr)" gap={"24px"} mb={8}>
					{/* Web GUID Card */}
					<GridItem>
						<Box
							borderWidth="1px"
